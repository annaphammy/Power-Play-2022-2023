...
import com.qualcomm.robotcore.util.ElapsedTime;
    ...
    @Autonomous(name= "Right", group = "P1;  RED")
    public class R1P1  extends LinearOpMode {
        ...
        */
        ...
        //    claw.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
           ...
           /*
            ...
            Plan 1 consist of;
            1. preload on ground junction
            2. stack
            3. high junction
             ( repeat )
             - as much as leaving time to scan and park 10 seconds
             - Speed and consistant
             - Make good points in auton



            waitForStart();
            // 1 Base movement first
            //2 Add in the claw and cascade and such

            //ground junction op
            encoderStrafeLeft(.5, 8,8, 1000);
            encoderDrive(.5,5,5,1000);

            //cone op
            encoderStrafeLeft(.5,3,3 , 1000);
            encoderDrive(.5,8,8,1000);

            //junction op
            encoderStrafeLeft(.5,5,5, 1000);
            encoderDrive(.5,5,5,1000);
